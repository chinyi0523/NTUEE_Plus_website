...
class Column extends Component {
	...
	render() {
		...
		const column_block_1910 = {
			...
			exp: [
				'林奕辰 現任：Bravo AI 洽吧智能執行長',
				'沈昇勳 現任：Bravo AI 洽吧智能技術長',
			],
			edu: [
				'林奕辰 學士：台灣大學電機系 (2016)',
				'沈昇勳 碩士：台灣大學電信所',
		...
		const column_block_1907 = {
			filename: '1907',
			anno: [
				'鄭謹譯 李筠婕 莊永松 戴慕潔 吳建翰 毛弘仁',
				'| 2019/08/28 星期三',
			],
			title: ['2012級 王易如  (行動貝果共同創辦人)'],
			exp: [
				'現任：MoBagel 共同創辦人，任職營運長',
				'聯絡方式：iruwang@mobagel.com',
			],
			edu: [
		...
		const column_block_1604 = {
			filename: '1604',
			anno: ['吳奕萱 楊程皓 毛弘仁 江庭瑋 蘇峯廣', '| 2017/3/30 星期四'],
			title: [
		...
		const column_block_1603 = {
			filename: '1603',
			anno: ['許秉鈞 袁培傑 劉禹辰 曾耕森', '| 2017/2/27 星期一'],
			...
			id: 'Column_Block_1603',
		}
		const column_block_1602 = {
			filename: '1602',
			anno: ['藍珮瑜 Steven Huang 林昱嘉 陳柏瑞', '| 2017/5/12 星期五'],
			...
			id: 'Column_Block_1602',
		}
		const column_block_1601 = {
			filename: '1601',
			anno: ['廖宜倫 黃暐倫 楊耀程 孫裕修 林恆陞', '| 2017/3/13 星期一'],
			...
			id: 'Column_Block_1601',
		}

		return (
			<div id='column_block_container'>
				<Column_block link='/in/Column/pages/2001' block={column_block_2001} />
				<Column_block link='/in/Column/pages/1912' block={column_block_1912} />
				<Column_block link='/in/Column/pages/1910' block={column_block_1910} />
				<Column_block link='/in/Column/pages/1909' block={column_block_1909} />
				<Column_block link='/in/Column/pages/1908' block={column_block_1908} />
				<Column_block link='/in/Column/pages/1907' block={column_block_1907} />
				<Column_block link='/in/Column/pages/1808' block={column_block_1808} />
				...
				<Column_block
					link='/in/Column/pages/HungMingJiun'
					block={column_block_HungMingJiun}
				/>
				...
				<Column_block link='/in/Column/pages/1603' block={column_block_1603} />
			...
			/*
				...
				<Column_block link="/in/Column/pages/1912">
					<div id = "column_block_section" onclick="/in/Column/pages/1912">
						<div id = "column_block_img"><img src= {nin_Dec_image} alt="img_1912" className="column_block_image"/></div = {column_block_1912}/>
					</div>
				</a>

				<Column_block link="/in/Column/pages/1910">
					<div id = "column_block_section" onclick="/in/Column/pages/1910">
						<div id = "column_block_img"><img src= {nin_Oct_image} alt="img_1910" className="column_block_image"/></div = {column_block_1910}/>
					</div>
				</a>
                
                <Column_block link="/in/Column/pages/1909">
					<div id = "column_block_section" onclick="/in/Column/pages/1909">
						<div id = "column_block_img"><img src= {nin_Sep_image} alt="img_1909" className="column_block_image"/></div = {column_block_1909}/>
					</div>
				</a>
                
                <Column_block link="/in/Column/pages/1908">
					<div id = "column_block_section" onclick="/in/Column/pages/1908">
						<div id = "column_block_img"><img src= {nin_Aug_image} alt="img_1908" className="column_block_image"/></div = {column_block_1908}/>
					</div>
				</a>
                
                <Column_block link="/in/Column/pages/1907">
					<div id = "column_block_section" onclick="/in/Column/pages/1907">
						<div id = "column_block_img"><img src= {nin_Jul_image} alt="img_1907" className="column_block_image"/></div = {column_block_1907}/>
					</div>
				</a>
                
                <Column_block link="/in/Column/pages/1808">
					<div id = "column_block_section" onclick="/in/Column/pages/1808">
						<div id = "column_block_img"><img src= {eig_Aug_image} alt="img_1808" className="column_block_image"/></div = {column_block_1808}/>
					</div>
				</a>
                
                <Column_block link="/in/Column/pages/1807">
					<div id = "column_block_section" onclick="/in/Column/pages/1807">
						<div id = "column_block_img"><img src= {eig_Jul_image} alt="img_1807" className="column_block_image"/></div = {column_block_1807}/>
					</div>
				</a>
                
                <Column_block link="/in/Column/pages/1806">
					<div id = "column_block_section" onclick="/in/Column/pages/1806">
						<div id = "column_block_img"><img src= {eig_Jun_image} alt="img_1806" className="column_block_image"/></div = {column_block_1806}/>
					</div>
				</a>
                 
                <Column_block link="/in/Column/pages/1805">
					<div id = "column_block_section" onclick="/in/Column/pages/1805">
						<div id = "column_block_img"><img src= {eig_May_image} alt="img_1805" className="column_block_image"/></div = {column_block_1805}/>
					</div>
				</a> }*/
		)
	}
