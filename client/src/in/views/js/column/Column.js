...
import { saveImg } from '../../../controllers/columnImgFunc/saveImg'
import '../../css/column/Column.css'
...
import '../../css/column/Column_block.css'
import { getImg } from '../../../controllers/columnImgFunc/getImg'

/* ============ Title ===========*/
const Column_block_title = (props) => {
	const _id = props.id
	const _title = props.title
	const Listitems = _title.map((Intro) => <p>{Intro}</p>)
	return (
		<span id={_id} class='column_block_title'>
			{Listitems}
		</span>
	)
}
...
const Column_block_exp = (props) => {
	...
	const Listintro = _exp.map((Intro) => <p>{Intro}</p>)
	return (
		<p id={_id} class='column_block_introtext'>
			{Listintro}
		</p>
	)
}
...
const Column_block_edu = (props) => {
	...
	const Listintro = _edu.map((Intro) => <p>{Intro}</p>)
	return (
		<p id={_id} class='column_block_introtext'>
			{Listintro}
		</p>
...
const Column_block_intro = (props) => {
	...
	const Listintro = _intro.map((Intro) => <p>{Intro}</p>)
	return (
		<p id={_id} class='column_block_introtext'>
			{Listintro}
		</p>
