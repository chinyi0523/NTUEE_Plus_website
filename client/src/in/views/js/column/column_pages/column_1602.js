...
class Column_1602 extends Component {
	render() {
					...
					sections: [
						{
							title: '多才多藝的人',
							section:
								'我從台南北上讀書，鄉下人進城，覺得系上每個人都好厲害。很會讀書是基本功夫，其他課外活動例如搞社團的、運動的，連打電動都打到極致，覺得系上的高手實在太多了，讓我大開眼界，這也是念電機最大的收穫，每個人在不同領域都很厲害，真的蠻佩服同學們的。台大是一個非常棒的地方，高手雲集，從別人身上看到自己不足的地方，也更有機會找到自己的優勢。“人”是我覺得念電機系這段時光最寶貴的經驗。',
						},
						{
							title: '各式各樣的課',
							section:
					...
					sections: [
						{
							title: '畢業方向',
							section:
								'其實那時候也沒有很確定。我知道自己的抽象思考 (電磁學，哈!) 比較弱，實作是明顯的強項，個性上比較喜歡廣而淺、而不是鑽而深。所以那時候決定去讀商學院，不過又選擇了數理比較強的CarnegieMellon，拿了兩個碩士，除了MBA，另外一個degree是財務數學，發揮我們在數理的所長。幸好這樣的academic background支持我進入金融業，說來也是有些運氣成份。',
						},
						{
							title: '申請困難',
							section:
						...
						},
						{
							title: '出國環境',
							section:
								'融入當然還是會有一定難度啦，我們本來就是外國人的身分，不過還是個性因素主導。脫離了舒適圈，大家還不都適應過來了，時間一久自然就習慣了。缺點就是花很多錢吧，優點的話主要還是眼界。我們電機系真的很棒，有一流的師資陣容跟研究環境，全球的排名也是很前面。留在系上繼續深造，一來省錢，二來可以跟著熟識的老師不間斷地繼續深入作研究。但是國外唸書的話，可以體驗不同的文化、同學，然後又遇到一群也是很厲害的人。外國的好手也多，到美國之後也能了解不同環境做人做事的方法。只能說各有優缺點，有時還是要靠一點運氣，可能幾年後或幾十年後才會證明當初的選擇。',
						},
						{
							title: '先備知識',
							section:
				...
				},
				{
					...
					sections: [
						...
						},
						{
							title: '金融工程前景',
							section:
								'很可惜，我覺得在台灣前景不佳。主要是規管限制金融商品在台灣的發行，因此金融工程人員多數在香港、新加坡、東京、上海等地發展。台灣的金融業還停留在手工階段，沒有連結科技、效率、與系統化，所以常常出紕漏。這方面要進步不是那麼容易，特別是已經落後了許多，而全球各金融中心也持續進步。這是對於台灣本地的金融工程發展前景而言。對於對金融工程有興趣的同學，發展的前景還是不錯的。',
						},
					],
				},
				{
					...
					sections: [
						...
						},
						{
							title: '適應壓力',
							section:
								'金融交易是個壓力極大的工作，如果神經太小條，太容易被情緒影響，做這行也許不是那麼適合。做事要仔細，心則要放寬一點，看到漲跌不能太緊張，不然身體受不了。交易員這種高壓行業也做不了多久，大概就是十幾二十年了。外資交易員手頭上都有幾十億幾百億的資金，純粹是按照我們的判斷去建立投資部位，目標在儘量降低風險的情況之下增加交易獲利。當然這樣的授權金額相當大，在台灣的公司不太可能發生。',
						},
						{
							title: '享受辛苦',
							section:
								'1997年來到香港，剛去的時候舉目無親，廣東話不會講，一直到一年後才第一次跟在港台灣人一起吃飯聚會，和現在香港到處都是台灣人的情況是完全不同。每天的生活就是早上七點出發，路上買一個麵包和咖啡到公司；中午在公司吃便當；晚上八點下班，路上順便買個便當打發晚餐，每天就這樣的routine。連週末都拼命看書補充不足，研究公司的文件。辛苦是辛苦，不過還是很enjoy這份工作，值得付出很多的心力。',
						},
					],
				},
				{
		...
		return (
			<div>
				<Column_content content={column_1602_article} />
			</div>
		)
	}
}

export default Column_1602
