			...
			sections: [
					...
					sections: [
						{
							...
							section:
								'我們主要是做有歌詞的音樂為主。過去比較多做音樂當中聲音信號的分析，近期比較多做跟樂譜有關的「音樂生成」 (music generation)的研究。做音樂研究的好處是可以聽很多音樂，而且建出來的模型 (model)的結果是可以聽的。過去做音樂情緒辨識的時候，就會同時考慮聲音和歌詞。近來在做音樂生成，也很有興趣能同時產生詞曲，或是給詞填曲、給曲填詞。(問：音樂情緒辨識是指電腦聽了之後可以判斷音樂是屬於憂傷的還是快樂的嗎？)對，那時候就是做這樣的題目。',
						},
						{
				...
				},
				{
					...
					sections: [
						{
							title:
								'教授曾經和國外許多之知名的教授和學者一起做研究，這些經歷帶給教授哪些收穫？',
							section:
								'透過這些經歷，我會期待自己用國際級的標準來做研究，而不是當國內王。會想要讓其他國家的學者，聽到你的名字就知道你在做什麼，甚至想到一個研究題目就會想到你的名字。有這樣的目標，自然而然會去把研究做好。如果有機會參與一些大型計畫就參與，沒有也沒關係。不需要特別去追求些什麼曝光度、或是名利。把自己有興趣的事情做好，盡量花足夠的時間跟實驗室的人討論他們的研究，幫助他們變得更好。',
						},
						{
							title:
								'教授的研究成果非常的多產及豐富，我們好奇教授您有經歷過低潮期嗎？',
							section:
								'其實還好耶。我覺得一來是抗壓性、二來是正面思考。人生要做很多選擇，我會確認我做的選擇是我喜歡的，但如果後來覺得過程或是成果沒那麼好，我會找些理由去安慰自己說「嗯，這個東西應該還是有些價值在裡面，其實也沒那麼差」，就是去看正面的部分。以研究來說，正面結果和負面結果有時候是一樣有趣的，研究論文也不能只是報喜不報憂。',
						},
						{
							title: '教授是怎麼找到研究的靈感？',
							section:
								'研究通常是越做會越有心得。剛開始比較不熟的時候就是靠多跟老師或是學長姐討論，千萬不要悶著頭自己蠻幹。學會與別人討論、與別人分享是很重要的，需要建立表達的能力。慢慢有一些自信心之後，就會越來越有想法想試。如果你對某個題目真的有興趣，就可以多找論文來看。我發現我實驗室裡面，研究做得特別好的，他們會主動去抓論文來看，而且常常看得比我還快。也就是說，研究做得好的人通常也看很多論文，有時候靈感就是從那邊來的。我自己當初在做音樂情緒的研究的時候，很多靈感也是從心理學那邊的論文來的，所以也不一定是只讀自己研究領域的論文。',
						},
						{
							title: '教授有曾經考慮過音樂資訊以外的領域嗎？',
							section:
								'這前面有稍微提過了，我曾經有為了自己畢業之後可否順利找到工作擔心過。因為音樂的研究確實比較小眾。來了中研院之後，也會覺得把我們這些如果機器學習的知識應用在其他領域 (例如綠能、或是氣候變遷)，或是會有更大的影響力。但一方面這樣想，另一方面又覺得音樂研究很有趣，彷彿有種使命感，就覺得應該繼續做下去，所以目前還沒有想要換領域。另外，也可能由於我是一位基督徒的關係，並不會特別想汲汲營營追求什麼。我珍賞心中這種平安的感覺。',
						},
						{
							title: '教授認為研究對您做重要的是什麼？',
							section:
								'應該是成就感、以及好奇心被滿足的感覺吧！能發現一些新的東西、或是做出一些被其他人覺得有用或是有趣的研究真的很好。這或許是大部分喜歡學術研究的人的通貌。',
						},
						{
							title:
								'假設我們在做專題的時候，自己的想法跟教授的想法有點出入，像是教授不支持你的研究方法等等，應該要怎麼辦？',
							section:
								'首先要試著溝通。表達與溝通能力是我們成長過程中比較沒有被訓練到的，但出社會之後充滿許多人與人意見不同的時候，就需要表達與溝通能力。再者，也許可以考慮換實驗室。以大學專題生來說，因為重點是發現自己的興趣，所以應該是希望可以盡量從那個實驗室學到東西。要是覺得不適合，其實不用勉強。我這裡說的不是淺嘗則止、說換就換，而是要誠實地評估自己的表現，找出能夠給實驗室貢獻、又能讓自己成長的方式。如果用單純只是拿學分的心態在進行專題研究，就實在是太可惜了。通常會建議做老師或是實驗室擅長的題目。有些老師會願意讓專題生去做一些比較不確定的題目，若對自己有自信、也覺得還能跟老師或學長討論，那也是可以試試看。一樣，這沒有標準答案，完全因每個人的興趣和個性而定。不過，在進一間實驗室前的確可以多蒐集一些情報，確定實驗室的風氣與自己期待的是否相符。以個性而言，有人喜歡自己獨立一些、有人喜歡跟很多人討論。基本上我覺得多討論總是好的，所以我建議去討論風氣比較興盛的實驗室。在實驗室裏面，就是儘量找人討論，他剛開始不理你也沒關係，就是找他討論，然後一起去吃飯之類，拉近關係，這樣會學得比較快。不要只是想著自己、也可以想想怎麼樣幫助實驗室的其他人。自己若將來成為實驗室比較資深的學長姊了，也要樂於與學弟妹分享，帶動討論的氣氛。然後修課成績其實不是很重要，除非你們想出國去一流名校念書，不然的話多嘗試一些東西其實比較重要。我知道很多人甚至會修兩個專題，或是在台大修一個專題、到中研院再找一個實驗室做(沒有學分的)專題研究。也有人花在專題上的時間比修課的時間還多。我覺得這是量力而為，不過有時候動手做真的滿有趣的。做研究其實並不是以發論文為目標，而是以讓自己成長為目標。發論文是種公認的量化的指標，但也不用因為自己沒發論文、同學有發論文，而否定自己。重點還是看自己是否有成長。在找研究所或是工作面試的時候，能不能答得出自己做過些什麼、喜歡什麼、曾經解過怎麼樣的難題，有時候反而是更重要的。',
						},
						{
							title: '大學部做專題這件事情，您覺得它最重要的收穫是甚麼？',
							section:
								'我覺得以career來說，能夠做一些跟研究相關、開創性的事情，會比較有趣。就算是去公司，也可以參與一些比較有研發性質的題目，並不一定都只是routine的工作。大學生參與專題研究，就是給你這麼一個機會，讓你經歷研發的過程。因為書本上的東西都是以前人研究的成果，那都是人家已經知道的，做研究就是要做沒人做過的研究。當你研究做到一個程度之後，你會發現前面已經沒什麼人了。單看你在研究的題目，全世界鑽的比你深的人沒幾個，到了那個時候就會覺得很有趣。就算還不到那個程度，但光你寫的東西能夠動起來，也是蠻厲害的。再來，會不會做研究跟會不會念書是兩回事，所以不要因為課業成績不好就覺得悲觀。若因為自己的成績落在班上排名的後面就喪失自信，那實在是太可惜了。長遠來看，大家都是同輩當中最聰明的一群人，所以就嘗試看看吧。當然，做研究只是人生諸多選項一個而已，不喜歡做研究的話，也完全沒有問題。',
						},
						{
							title: '要怎麼樣不為了發paper做研究？',
							section:
								'(註：假如你想做的題目不是很好發paper，是不是應該改做不是很有用卻可以發一堆小paper的題目？)剛開始很難免會為了發論文而做研究，因為大家難免希望從發表論文中得到肯定和信心。但是，有些研究難度就是比較高，需要較多的時間研究、其中也會遭遇許多挫折。這種時候，就要能夠忍受一些寂寞，也就是研究時間會拉比較長。要是覺得有趣、也覺得自己能力夠強，那還是可以挑戰看看。你自己都知道題目夠難，能做出來的人都還是能夠發論文，只是發的快或慢的問題。我很喜歡一句話，「跑得快不代表跑得遠」，就看你要當跑得快的人還是跑得遠的人。所以這很難講。你可能跑得很快、發了些還OK的論文；你也可以選擇耕耘久一些，發一篇高水準的論文。那到底誰比較厲害？其實很難講，不一定。比較沒把握的話，可以從一些較小的題目開始，慢慢有經驗之後再挑戰大的。或者，可以先設定一些目標，例如要投稿哪個會議，再根據該會議地截稿時間往前推算，看可以做哪些事情。這都可以跟指導教授討論，但每個實驗室的風氣可能不同，建議還是要找自己合得來的實驗室。',
						},
						{
							title: '教授是如何訓練您的學生？',
							section:
								'如果你是問我怎麼訓練學生的話，我會說國際觀很重要，所以我會常常讓他們去參加會議。如果是博士生的話，我會幫他們找機會去國外待一陣子，不要博士期間整段時間都待在臺灣。 反過來說，如果你的問題是：做為一個學生，我如果將來進一個實驗室，要怎麼樣可以比較快融入那個實驗室，比較快做的好？則我有兩個建議：第一個是，你們從高中一直到大學，其實都沒有面對過所謂的老闆。所以進到一個實驗室，當你老闆會對你有進度的要求的時候，你會有些壓力，可能會體驗到一些出社會的感覺。你在學校修課教授又不會拿你怎麼樣，頂多把你當掉而已，那是你念書不念書的問題。可是做研究的時候你需要直接面對你的指導教授，以及從他而來的壓力。像我之前說的，每個人適合的老師不一樣，要求高的老師可能可以讓你學到比較多東西，但你要學會與這樣的壓力共處。在一個氣氛較輕鬆的實驗室也是可以做好研究，但那就要學會自我要求。總之是抱著上進的心情，不求只是利己，而是希望自己跟實驗室可以一起變得更好。分享真的是很重要的。大家都生長在臺灣，都是臺灣未來的棟樑。可以的話不要一直存著競爭心態，而是大家有什麼訊息或收穫，就儘量多分享。同儕間、學長姐學弟妹間、甚至將來出社會之後跟同事之間，都懷抱著這樣的心情，而不是只是把別人壓過去讓自己出頭。不吝於分享、也不吝於尋求別人的幫忙。大家一起變好，那我們臺灣就會跟著變的更好。',
						},
					],
				},
			],
