...
import {
	...
	handleCheckChange,
	handleInputChange,
} from '../../controllers/profileFunc/handleChange.js'
import {
	showVisual,
	handleSubmit,
} from '../../controllers/profileFunc/showAndSubmit'
import { map } from '../../controllers/profileFunc/map'
		...
		return (
			<div id='Profile_container'>
				<div id='hr0' className='ml-1 mt-2 d-flex justify-content-between'>
					...
					>
						<img src={edit} className='img-fluid Profile_edit_icon' />
