...
import '../../css/career/recruitment.css'
...
import '../../css/career/Recruitment_block.css'
...
const Recruitment_block = (props) => {
	...
	return (
		<div
			id='Recruitment_block_container'
			className='card col-xl-10 mx-auto my-5'
			style={{ boxShadow: '2px 2px rgba(12, 28, 99, 0.1)' }}
		>
			<div className='d-flex justify-content-center'>
				<img
					className='card-img-top img-fluid Recruitment_block_image'
					src={recruit_image}
					id={id + '_image'}
