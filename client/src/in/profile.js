...
class Profile extends Component {
    ...
    addOccupation(haveVal) {
        ...
        this.setState(toSet, function () {
            ...
            new_input_O.setAttribute("class", "Profile_info_table_input Profile_info_input");
            new_input_P.setAttribute("class", "Profile_info_table_input Profile_info_input");
            new_input_C.setAttribute("class", "Profile_info_table_input Profile_info_input");
        ...
        return (
            <div id="Profile_container">
                <div id="hr0" className="ml-1 mt-2 d-flex justify-content-between">
                    ...
                    <button className="btn Profile_edit_btn pl-0"
                        onClick={(e) => {
                            e.preventDefault()
                            this.editMode(true)
                        }}>
                        <img src={edit} className="img-fluid Profile_edit_icon" /><p className="d-none d-sm-inline">Edit</p>
                    </button>
                </div>
                <div id="Profile_information" className="container-fluid mb-5">
                    {/* <p id="Profile_public">Public</p> */}
                    <form id="Profile_loginform" 
                    onSubmit={(e) =>{
                        this.handleSubmit(e)
                        this.editMode(false)
                        }}>
                        <div id="Profile_userimage_container" className="mt-3">
                            <div className="d-flex justify-content-center">
                                <img src={this.state.imagePreviewUrl} id="Profile_userimage" className="img-fluid"></img>
                            </div>
                            <label id="Profile_userimage_change" className="mt-2 d-flex justify-content-center">
                                <input type="file"
                                ...
                                <span id="Profile_addImage_icon" >➕<p style={{ display: "inline" }}>Add Head Shot</p></span>
                            </label>
                        </div>
                        ...
                        <div id="Profile_info">
                            <div id="Profile_name" className="mb-4">
                                ...
                                <div className="form-group row mx-auto">
                                    <label className="col-form-label Profile_info_label col-4">Realname:</label>
                                    {/* <input type="checkbox" id="Profile_realname_checkbox" 
                                    checked = {this.state.realname_checkbox}
                                    onChange = {this.handleCheckChange}
                                    name="realname_checkbox" ></input> */}
                                    <input type="text" className="form-control Profile_info_input col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3" value={this.state.realname} onChange={this.handleInputChange} name="realname"></input>
                                </div>
                                <div className="form-group row mx-auto">
                                    <label className="col-form-label Profile_info_label col-4">Nickname:</label>
                                    {/* <input type="checkbox" id="Profile_nickname_checkbox"
                                    checked = {this.state.nickname_checkbox}
                                    onChange = {this.handleCheckChange}
                                    name="nickname_checkbox"></input> */}
                                    <input type="text" className="form-control Profile_info_input col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3" value={this.state.nickname} onChange={this.handleInputChange} name="nickname"></input>
                                </div>
                            </div>
                            <div>
                        ...
                        <div id="hr1" className="Profile_hr">How to Contact</div>
                        <div id="Profile_more_info">

                            <div className="form-group row mx-auto">
                                <label className="col-form-label col-4 Profile_info_label">Email:</label>
                                {/* <input type="checkbox"
                                    checked={this.state.email_checkbox}
                                    onChange={this.handleCheckChange}
                                    name="email_checkbox"
                                ></input> */}
                                <input type="email" id="Profile_email" className="form-control Profile_info_input col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3" value={this.state.email} onChange={this.handleInputChange} name="email"></input>
                            </div>
                            <div className="form-group row mx-auto">
                                <label className="col-form-label col-5 Profile_info_label">Living Address:</label>
                                {/* <input type="checkbox"
                                    checked={this.state.address_checkbox}
                                    onChange={this.handleCheckChange}
                                    name="address_checkbox"
                                ></input> */}
                                <input type="address" className="form-control col-7 col-md-6 col-xl-5 offset-md-1 offset-xl-2 Profile_info_input" id="address" value={this.state.address} onChange={this.handleInputChange} name="address"></input>
                            </div>
                            <div className="form-group row mx-auto">
                                <label className="col-form-label col-5 Profile_info_label">Phone(Office):</label>
                                <button className="Profile_expand_button"
                                    onClick={(e) => {
                                        e.preventDefault();
                                        this.expandDiploma("Profile_expand_phone", "hr4", "Profile_expand_icon_1", "2rem", "0rem")
                                    }}
                                >
                                ...
                                ></input> */}
                                <input id="Profile_phone_company" className="form-control col-5 ml-auto Profile_info_input"
                                    value={this.state.phone_company} onChange={this.handleInputChange} name="phone_company"
                                    onFocus={(e) => {
                                        e.preventDefault();
                            ...
                            <div id="Profile_expand_phone">
                                ...
                                <div className="form-group row mx-auto">
                                    <label className="col-form-label col-4 Profile_info_label">Phone(Home):</label>
                                    {/* <input type="checkbox"
                                        checked={this.state.phone_home_checkbox}
                                        onChange={this.handleCheckChange}
                                        name="phone_home_checkbox"
                                    ></input> */}
                                    <input id="Profile_phone_home" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" value={this.state.phone_home} onChange={this.handleInputChange} name="phone_home"></input>
                                </div>
                                <div className="form-group row mx-auto">
                                    <label className="col-form-label col-4 Profile_info_label">Mobile:</label>
                                    {/* <input type="checkbox"
                                        checked={this.state.mobile_checkbox}
                                        onChange={this.handleCheckChange}
                                        name="mobile_checkbox"
                                    ></input> */}
                                    <input id="Profile_mobile" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" value={this.state.mobile} onChange={this.handleInputChange} name="mobile"></input>
                                </div>

                            </div>

                            <div id="hr4" className="Profile_hr">Social Media</div>
                            <div id="Profile_social_media">

                                <div className="form-group row mx-auto">
                                    <label className="col-form-label col-4 Profile_info_label">Facebook:</label>
                                    <button className="Profile_expand_button"
                                        onClick={(e) => {
                                            e.preventDefault();
                                            this.expandDiploma("Profile_expand_social_media", "hr2", "Profile_expand_icon_2", "2rem", "1rem")
                                        }}>
                                    ...
                                    ></input> */}
                                    <input id="Profile_FB" className="form-control col-6 ml-auto Profile_info_input"
                                        value={this.state.facebook} onChange={this.handleInputChange} name="facebook"
                                        onFocus={(e) => {
                                            e.preventDefault();
                                            this.expandDiploma("Profile_expand_social_media", "hr2", "Profile_expand_icon_2", "2rem", "1rem")
                                        }}></input>
                                ...
                                <div id="Profile_expand_social_media">
                                    ...
                                    <div className="form-group row mx-auto">
                                        <label className="col-form-label col-4 Profile_info_label">Blog:</label>
                                        {/* <input type="checkbox"
                                            checked={this.state.personal_website_checkbox}
                                            onChange={this.handleCheckChange}
                                            name="personal_website_checkbox"
                                        ></input> */}
                                        <input id="Profile_personal_website" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" value={this.state.personal_website} onChange={this.handleInputChange} name="personal_website"></input>
                                    </div>
                                    <div className="form-group row mx-auto">
                                        <label className="col-form-label col-4 Profile_info_label">Linkedin:</label>
                                        {/* <input type="checkbox"
                                            checked={this.state.Linkedin_checkbox}
                                            onChange={this.handleCheckChange}
                                            name="Linkedin_checkbox"
                                        ></input> */}
                                        <input id="Profile_Linkedin" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" value={this.state.Linkedin} onChange={this.handleInputChange} name="Linkedin"></input>
                                    </div>

                                </div>

                            </div>
                            <div id="hr2" className="Profile_hr">Diploma</div>
                            <div id="Profile_diploma_container">
                                <div className="form-group row mx-auto">
                                    <label className="col-form-label col-4 Profile_info_label">Bachelor Major:</label>
                                    <button className="Profile_expand_button"
                                        onClick={(e) => {
                                            e.preventDefault();
                                            this.expandDiploma("Profile_expand_diploma", "hr41", "Profile_expand_icon_3", "1rem", "1rem")

                                        }}>
                                        <img className="Profile_expand_icon" id="Profile_expand_icon_3" src={show_more} alt="show_more">
                                        </img>
                                    </button>
                                    <input id="Profile_diploma_bachelor_major" className="form-control col-5 ml-auto offset-1 Profile_info_input"
                                        value={this.state.diploma_bachelor_major} onChange={this.handleInputChange} name="diploma_bachelor_major"
                                        onFocus={(e) => {
                                            e.preventDefault();
                                            this.expandDiploma("Profile_expand_diploma", "hr41", "Profile_expand_icon_3", "1rem", "1rem")
                                ...
                                <div id="Profile_expand_diploma">
                                    <div className="form-group row mx-auto">
                                        <label className="col-form-label col-4 Profile_info_label">Double:</label>
                                        <input className="Profile_input_nonfloat form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" id="Profile_diploma_bachelor_double_major" value={this.state.diploma_bachelor_double_major} onChange={this.handleInputChange} name="diploma_bachelor_double_major"></input>
                                    </div>
                                    <div className="form-group row mx-auto">
                                        <label className="col-form-label col-4 Profile_info_label">Minor:</label>
                                        <input className="Profile_input_nonfloat form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" id="diploma_bachelor_minor" value={this.state.diploma_bachelor_minor} onChange={this.handleInputChange} name="diploma_bachelor_minor"></input>
                                    </div>
                                    {/* <input type="checkbox"
                                            className="Profile_diploma_checkbox"
                                    ...
                                    <div className="form-group row mx-auto">
                                        <label className="col-form-label col-4 Profile_info_label">Master:</label>
                                        <input id="Profile_diploma_master" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" value={this.state.diploma_master} onChange={this.handleInputChange} name="diploma_master" ></input>
                                        {/* <input type="checkbox"
                                            className="Profile_diploma_checkbox"
                                    ...
                                    <div className="form-group row mx-auto">
                                        <label className="col-form-label col-4 Profile_info_label">Doctor:</label>
                                        <input id="Profile_diploma_doctor" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" value={this.state.diploma_doctor} onChange={this.handleInputChange} name="diploma_doctor"></input>
                                        {/* <input type="checkbox"
                                            className="Profile_diploma_checkbox"
                            ...
                            <div id="hr41" className="Profile_hr">Work Experience</div>
                            <div id="Profile_occupation_container" className="mt-1">
                                <table id="Profile_occupation_table" className="table table-responsive col-12">
                                    <thead >
                                ...
                                <div className="form-group row mx-auto">
                                    <label className="col-form-label col-4 Profile_info_label">JobID</label>
                                    <input id="Profile_JobID" className="form-control col-7 col-md-6 col-xl-5 offset-1 offset-md-2 offset-xl-3 Profile_info_input" name="JobID" value={this.state.JobID} onChange={this.handleInputChange}></input>
                                </div>
                            </div>
                            <div className="d-flex justify-content-center mt-5">
                                <input id="Profile_submit_btn" className="btn" type="submit" value="Update Profile" />
                            </div>
                        </div>
                    </form>
