...
import './Recommendation_requirement.css';

class Recommendation_block_requirement extends Component{
    constructor(props){
        super(props);
        this.state = {
    ...
    render(){
        return(
            <div id={this.state.id} class="Recommendation_block_requirement">
                <li id = 'Recommendation_block_requirement'>學歷</li>
                {/* {this.state.requirement} */}
            </div>
        )
    }
}
export default Recommendation_block_requirement;