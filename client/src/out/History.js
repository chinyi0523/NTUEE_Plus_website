                    ...
                    <div id="History_B06">
                        ...
                        <div className="container justify-content-center d-lg-flex d-block mx-auto">
                            <div className="col-12 col-lg-6 d-flex justify-content-center">
                                <img src={B06_all} alt="4th all members" className="img-fluid " style={{ minWidth: "300px" }} />
                            </div>
                            <div className="w-100 d-block d-lg-none"></div>
                            <div id="History_member" className="col-12 col-lg-4 d-flex justify-content-center align-items-center">
...
{
    return (
        <div id={props.id} style={{ display: "inline-block" }} className="History_member_entity mx-5">
            <img src={props.photo_src} alt={props.name + "'s photo"} width="250px" height="250px" />
            <p id={props.id + "_name"}>
                {props.name}
            </p>
        </div>
