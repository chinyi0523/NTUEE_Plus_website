	...
	render() {
		return (
			<div>
				...
				<ul>
					...
					<li>
						<p>
							...
							"We", "Us" or "Our" in this Agreement) refers to NTUEE+.
						</p>
					</li>
					<li>
					...
					<li>
						<strong>Website</strong> refers to NTUEE+, accessible from
						https://plus.ntuee.org/
					</li>{' '}
					<li>
				...
				<ul>
					<li>By email: ntueeplus2020@gmail.com</li>
					<li>
						By visiting this page on our website: https://plus.ntuee.org/Contact
					</li>
				</ul>
			</div>
		)
