...
import '../css/Register_account.css'
	...
	render() {
		...
		if (imagePreviewUrl) {
			$imagePreview = (
				<img
					src={imagePreviewUrl}
					className='img-fluid container justify-content-center d-flex'
					id='Register_acc_id_photo'
				/>
			)
		} else {
			$imagePreview = (
			...
			<div id='Register_acc_container'>
				<div id='Register_acc_register_table' className='container-fluid mt-3'>
					...
					<form onSubmit={this.handleSubmit}>
						<div
							id='Register_acc_table'
							className='col-11 pl-0 pl-md-1 col-xl-8 mt-5 mr-0 d-xl-inline-block mx-auto'
						>
							<div className='form-group row'>
								<label
									id='Register_acc_realname_label'
									className='col-form-label col-5 col-sm-4 col-md-3 Register_account_label text-center text-lg-left'
								>
									Your Name
								</label>
								<input
									id='Register_acc_realname'
							...
							<div className='form-group row'>
								<label
									id='Register_acc_ID_label'
									className='col-form-label col-5 col-sm-4 col-md-3 Register_account_label text-center text-lg-left'
								>
									Student ID
								</label>
								<input
									id='Register_acc_student_id'
							...
							<div className='form-group row'>
								<label
									id='Register_acc_password_label'
									className='col-form-label col-5 col-sm-4 col-md-3 Register_account_label text-center text-lg-left'
								>
									Password
								</label>
								<input
									id='Register_acc_password'
							...
							<div className='form-group row'>
								<label
									id='Register_acc_confirm_password_label'
									className='col-form-label col-5 col-sm-4 col-md-3 Register_account_label text-center text-lg-left'
								>
									Confirm Password
								</label>
								<input
									id='Register_acc_confirm_password'
							...
							<div className='form-group row'>
								<label
									id='Register_acc_question_label'
									className='col-form-label col-5 col-sm-4 col-md-3 Register_account_label text-center text-lg-left'
								>
									Question
								</label>
								<input
									id='Register_acc_question'
							...
							<div className='form-group row'>
								...
								<label className='col-form-label offset-sm-1'>
									...
									/>
									<span
										id='Register_acc_addImage_icon'
										className='Register_account_input'
									>
										➕ <p style={{ display: 'inline' }}>Add Your ID Photo</p>
									</span>
								</label>
							</div>
							...
							<div className='d-flex justify-content-center mx-auto'>
								<button
									id='Register_acc_register_button'
						...
						<div
							id='Register_acc_FAQ'
							className='col-xl-3 d-xl-inline-block d-none ml-0 float-xl-right mt-5 mr-5'
						>
							...
							<div id='Register_acc_FAQ_content'>
								<ul id='Register_acc_FAQ_list'>
									<li>
										ID photo should contain your <em>full name</em> and{' '}
										<em>intact, clear face</em>.
									</li>
						...
						<div
							id='Register_acc_FAQ'
							className='d-block d-xl-none ml-0 float-xl-right mt-5'
						>
							<div id='Register_acc_FAQ_title'>Image Preview</div>
							<div id='Register_acc_splitline'></div>
							<div id='Register_imgPreview'>{$imagePreview}</div>
							<div id='Register_acc_FAQ_title'>FAQ</div>
							<div id='Register_acc_splitline'></div>
...
class Register_facebook extends Component {
	...
	render() {
		...
		return (
			<div id='Register_acc_container'>
				<div id='Register_acc_register_table' className='container-fluid mt-3'>
					<h1 id='Register_acc_table_title'>
						Just A Few Steps to Join EE+ With Facebook!
					</h1>
					<form onSubmit={this.handleSubmit}>
						<div
							id='Register_acc_table'
							className='col-11 col-xl-8 mt-5 mr-0 d-xl-inline-block mx-auto'
						>
							<div className='form-group row'>
								<label
									id='Register_acc_realname_label'
