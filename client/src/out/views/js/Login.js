			...
			<div>
				<div id='Login_container' className='container-fluid col-10'>
					...
					<form onSubmit={this.handleSubmit}>
						...
						>
							<div id='Login_username' className='form-group row mb-5'>
								...
								<input
									...
									className='Login_input form-control col-sm-6'
									placeholder='e.g. b06901000'
									autoFocus
							...
							<div
								id='Login_links'
								className='container-sm-fluid justify-content-sm-between d-sm-flex mx-sm-auto'
							>
								<Link id='Login_create' to='/Register'>
									Create a new account
								</Link>
								<div className='w-100 d-block d-sm-none'></div>
								<Link id='Login_forgot' to='/Forget'>
						...
						<div
							id='Login_hr'
							className='w-50 text-center container d-md-block d-none mt-3'
						>
							or login with...
						</div>
						<div
							id='Login_hr'
							className='w-100 text-center container d-md-none d-block mt-5'
						>
							or login with...
						</div>
					</form>
