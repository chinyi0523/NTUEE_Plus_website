...
const Recruitment = (props) =>{
	const [templates,setTemplates] = useState([emptyTemplate,emptyTemplate,emptyTemplate,emptyTemplate,emptyTemplate])
	useEffect(()=>{
			...
			<div className = "Recruitment_container col">
				<div className = "Recruitment_wrapper">
					<Link className='Recruitment_block'>
						<Recruitment_block data = {templates[0]} />
					</Link>
					<Link className='Recruitment_block'>
						<Recruitment_block data = {templates[2]} />
					</Link>
					<Link className='Recruitment_block'>
						<Recruitment_block data = {templates[4]}/>
					</Link>
				</div>
			</div>
			<div className = "Recruitment_container col">
				<div className = "Recruitment_wrapper">
					<Link className='Recruitment_block'>
						<Recruitment_block data = {templates[1]}/>
					</Link>
					<Link className='Recruitment_block'>
						<Recruitment_block data = {templates[3]}/>
					</Link>
				</div>
			</div>
			</div>
